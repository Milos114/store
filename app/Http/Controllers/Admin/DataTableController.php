    ...
    public function getProducts()
    {
        ...
        return Datatables::of($products)
            ...
            ->addColumn('edit', function ($product) {
                ...
                return '<a href="/admin/product/' . $product->id . '/delete" class="btn btn-xs btn-primary" onclick="return confirm(\'Are you sure?\')"><i class="glyphicon glyphicon-remove"></i> Delete</a>';
            })
            ->make(true);
    }
}
